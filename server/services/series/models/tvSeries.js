...
class TvSeriesModel {
    ...
    static update(id, payload){
        ...
        return TvSeries.findOneAndUpdate({"_id" : ObjectId(`${id}`)}, {$set: {"title":title, "overview":overview, "poster_path":poster_path, "popularity":popularity, "tags":tags}}, {returnOriginal:false} )
    }
